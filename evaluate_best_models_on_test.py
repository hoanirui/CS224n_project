...
def main():
    # load the vocabulary:
    vocabulary = cPickle.load(open("coco/data/vocabulary", "rb"))
    ...
    test_img_id_2_feature_vector =\
                cPickle.load(open("coco/data/test_img_id_2_feature_vector", "rb"))
    ...
    train_caption_id_2_caption = cPickle.load(open("coco/data/train_caption_id_2_caption", "rb"))
    train_captions = []
    ...
    LSTM_results_dict = evaluate_best_model("LSTM", test_img_ids, test_img_id_2_feature_vector, vocabulary,
               train_captions)
    # evaluate best GRU model:
    GRU_results_dict = evaluate_best_model("GRU", test_img_ids, test_img_id_2_feature_vector, vocabulary,
                train_captions)
    # evaluate best LSTM attention model:
    LSTM_att_results_dict =\
                evaluate_best_model("LSTM_attention", test_img_ids, test_img_id_2_feature_vector, vocabulary,
                train_captions)
    # evaluate best GRU attention model:
    GRU_att_results_dict =\
             evaluate_best_model("GRU_attention", test_img_ids, test_img_id_2_feature_vector, vocabulary,
                train_captions)
